        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="bg-gray-50 rounded-lg p-3 mb-4">
                  ...
                  <div className="bg-blue-50 rounded p-2 text-center font-mono font-medium text-blue-700 text-sm">
                    {referralCode}
                  </div>
                </div>
                ...
                <Button size="sm" className="w-full gap-2 bg-blue-700 hover:bg-blue-800">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <Button variant="outline" size="sm" className="w-full justify-start mb-2 text-gray-700">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex border-b border-gray-200 mb-6">
              <button
                className={`pb-2 px-4 font-medium text-sm ${activeTab === 'workshops' ? 'text-blue-700 border-b-2 border-blue-700' : 'text-gray-500'}`}
                onClick={() => setActiveTab('workshops')}
              >
                My Workshops
              </button>
              <button
                className={`pb-2 px-4 font-medium text-sm ${activeTab === 'certificates' ? 'text-blue-700 border-b-2 border-blue-700' : 'text-gray-500'}`}
              ...
              <div>
                ...
                {isLoading ? (
                  <div className="text-center py-8">
                    ...
                    <p className="mt-2 text-gray-500">Loading your workshops...</p>
                  </div>
                ) : (
